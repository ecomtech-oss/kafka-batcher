defmodule KafkaBatcher.ConfigTest do
  alias KafkaBatcher.Accumulator.DefaultBatchFlusher
  alias KafkaBatcher.Config

  alias KafkaBatcher.Test.{
    CalculatePartitionByKeyCollector,
    CalculatePartitionByValueCollector
  }
  ...
  test "supervisor child spec for collectors" do
    assert [
                 ...
                 {KafkaBatcher.AccumulatorsPoolSupervisor, :start_link,
                  [
                    [
                      ...
                      telemetry: true,
                      batch_flusher: DefaultBatchFlusher,
                      max_wait_time: 1000,
                      batch_size: 30,
                      min_delay: 0,
             ...
             %{
               id: CalculatePartitionByValueCollector,
               start:
                 {CalculatePartitionByValueCollector, :start_link,
                  [
                    [
                      ssl: false,
                      sasl: :undefined,
                 ...
                 {KafkaBatcher.AccumulatorsPoolSupervisor, :start_link,
                  [
                    [
                      ...
                      sasl: :undefined,
                      endpoints: [{"localhost", 9092}],
                      partition_fn: &CalculatePartitionByKeyCollector.calculate_partition/4,
                      allow_topic_auto_creation: false,
                      partition_strategy: :random,
                      required_acks: 1,
                      collect_by_partition: true,
             ...
             %{
               id: CalculatePartitionByKeyCollector,
               start:
                 {CalculatePartitionByKeyCollector, :start_link,
                  [
                    [
                      ssl: false,
                      sasl: :undefined,
